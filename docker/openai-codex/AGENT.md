...
<!--
⚠️  WARNING: This file is AUTO-GENERATED by docker/rules/generate-rules.js
    Do not edit this file directly. Instead, edit:
    - docker/rules/AGENT_RULES.base.md (for shared rules)
    - docker/rules//specific-rules.md (for agent-specific rules)
    Then regenerate by running: cd docker/rules && npm install && node generate-rules.js
-->
