...
<div class="hx-mt-6 hx-grid hx-grid-cols-1 md:hx-grid-cols-2 hx-gap-4">
  <div
  ...
  >
    ...
    <p class="hx-mt-4"><a href="{{< relref "MODELS.md" >}}">MODELS.md</a> lists example models per provider.</p>
  </div>
